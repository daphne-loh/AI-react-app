...
const PremiumModal: React.FC<PremiumModalProps> = ({ isOpen, onClose }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Premium Access">
      <div className="text-center">
        ...
        <button 
          className="w-full bg-gradient-to-r from-primary-600 to-primary-700 text-white py-2 px-4 rounded-lg text-sm font-medium hover:from-primary-700 hover:to-primary-800 transition-all duration-200"
          onClick={onClose}
        >
          Learn More
        </button>
