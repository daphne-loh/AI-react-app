...
// Direct Firebase configuration - bypassing environment variables for now
// TODO: Fix environment variable loading in Vite later
...
console.log('🔥 Using direct Firebase config - API Key loaded:', firebaseConfig.apiKey.substring(0, 10) + '...');
